...
from api.reset_password.models import PhoneNumberReset
from api.reset_password.models import find_code, add_verified_number


reset_code_verification = Blueprint('reset_code_verification', __name__)


@reset_code_verification.route('/reset_password/verify_code', methods=['POST'])
@jwt_required
def verify_code():
